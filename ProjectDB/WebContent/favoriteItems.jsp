...
<h1 style="color:#335B78;text-align:center;">FAVORITE ITEMS</h1> 
...
<br/>
	...
	String favItemTitle = request.getParameter("title");
    ...
    <th style = "border :1px solid black; padding: 15px;">Fav Item</th>
	</tr>
	<%
	try{ 
	connection = DriverManager.getConnection(connectionUrl+dbName, userId, password);
	statement=connection.createStatement();
	String sql ="SELECT * FROM favItems WHERE userEmail='" + userEmail + "'";
	...
	<td style = "border :1px solid black; padding: 15px;"><%=resultSet.getString("favItemUserEmail") %></td>
	<td style = "border :1px solid black; padding: 15px;"><%=resultSet.getString("title") %></td>
	<td style = "border :1px solid black; padding: 15px;">
		<button class="btn" title= "Delete" onclick="window.location.href='ControlServlet?delFavItemaction=deleteFavoriteItem&favUserEmail=${favItemUserEmail}&title=${title}'">
